      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            Schematic delivers flexible monetization by decoupling pricing from code and 
            giving GTM users the controls they need to drive growth
          </p>
        </div>
...
const WorkflowBox = React.forwardRef(function WorkflowBox(
  ...
  return (
    <div
      ref={ref}
      className={`relative flex flex-col items-center justify-center rounded-xl bg-gradient-to-br from-background/70 to-background/40 backdrop-blur supports-[backdrop-filter]:bg-background/60 border ring-1 ring-border/50 shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer ${className}`}
    >
